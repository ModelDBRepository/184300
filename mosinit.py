'''
Current clamp demo using Allen Brain's model 472447460.
...
from neuron472447460 import Neuron472447460
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron472447460(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 472447460; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-85.7733612061)
        h.fcurrent()
